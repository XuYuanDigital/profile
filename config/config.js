var config = {
    ...
    about: "<p>你好！我叫文神德，性别男，出生于广东省韶关市，现居广东省深圳市龙岗区。大学毕业后，入职于深圳新视觉科技有限公司，目前就职于深圳市蚂蚁数图技术有限的项目经理岗位。我热爱编程，喜欢研究新技术。我有丰富的项目经验，能够快速的学习新技术，并将其应用到实际项目中。我热爱生活，喜欢旅游、看书、看电影、听音乐。我是一个热爱生活、热爱工作、有责任心、有团队精神的人。我期望的工作岗位是项目经理。</p>" +
    ...
    */  
    ...
    work: [
        ...
        ["2020/7/1 — 2021/8/10", "<br>深圳地铁实习生",
            "<p><strong>通信技术部</strong></p>" +
            "<p>随着阴历7月15中元节的到来，深圳地铁的任务愈发庞大，我以及我所在小组主要负责阎王谱后台部分，拟在解决千万访问并发问题，经过不械努力，使得产品稳定、高效的运行。</p>" +
            "<p>随着阴历7月15中元节的到来，深圳地铁的任务愈发庞大，我以及我所在小组主要负责阎王谱后台部分，拟在解决千万访问并发问题，经过不械努力，使得产品稳定、高效的运行。</p>"
        ],

        ["2021/8/11 — 至今", "深圳市蚂蚁数图技术有限公司",
            "<p><strong>项目经理</strong></p>" +
            "<p>我是深圳市蚂蚁数图技术有限公司的项目经理，负责公司产品的研发、设计、开发、测试、运营等工作。我主要负责公司产品的研发、设计、开发、测试、运营等工作。</p>" +
            "<p>我是深圳市蚂蚁数图技术有限公司的项目经理，负责公司产品的研发、设计、开发、测试、运营等工作。我主要负责公司产品的研发、设计、开发、测试、运营等工作。</p>"
        ]
    ],
    ...
    others: [
        ...
        ["2020-11-14", "2020级深圳信息技术学院程序设计正式赛三等奖", "大一上学期，我参与校举办的面向全校程序设计大赛并获得三等奖，"]
    ],
